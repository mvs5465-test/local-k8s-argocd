...
echo "📌 Access:"
echo ""
echo "1. Point service hostnames at the mini-server IP:"
echo "   Add explicit .lan DNS records or explicit /etc/hosts entries for the services you want to expose."
echo ""
